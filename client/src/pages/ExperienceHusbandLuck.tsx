      ...
      <section className="relative overflow-hidden pt-16 pb-[150px] md:pt-24 md:pb-56">
        ...
        <div className="relative max-w-2xl mx-auto px-5 text-center">
          ...
          <h1 className="leading-tight text-slate-900">
            ...
            <span className="block text-3xl md:text-4xl font-light tracking-wide mt-1">1초 만에 아는 법</span>
          </h1>
        </div>
      </section>
        ...
        <div className="max-w-2xl mx-auto px-5 space-y-8">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 gap-3">
              ...
              <div className="rounded-xl bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 px-4 py-3 text-sm text-amber-800 dark:text-amber-300">
                ※ <strong>김씨</strong>는 ㄱ(木)이 아니라 <strong>金(금)</strong>으로 봅니다.
              </div>
            </div>
          ...
          <div ref={commentRef} className="space-y-5">
            ...
            <div className="text-center pt-2">
              <button onClick={() => navigator.share?.({ title:'남편복 1초 만에 아는 법', url: window.location.href })}
