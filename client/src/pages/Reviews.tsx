...
export default function Reviews() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero Section with character on left - negative margin pulls up over navbar spacer */}
      <section className="relative overflow-hidden bg-gradient-to-br from-[#0f766e] to-[#4fd1c5] dark:from-[#0a5850] dark:to-[#3ba89e] -mt-[80px] pt-[calc(80px+4rem)] pb-16 md:pt-[calc(80px+6rem)] md:pb-24">
