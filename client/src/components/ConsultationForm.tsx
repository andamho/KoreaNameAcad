            ...
            >
              ...
              <div className="relative z-10 flex flex-col h-full justify-between py-2">
                <div className="flex flex-col items-center">
                  <span className="text-sm font-bold tracking-wide text-white/90">Nonghyup Bank</span>
                </div>

                <div className="flex flex-col items-center space-y-2.5">
                  <div className="text-xl sm:text-2xl font-mono font-bold tracking-wider text-white whitespace-nowrap text-center">
                    351 8205 8124 53
                  </div>
                  ...
                  <button 
                    ...
                    className="group flex items-center gap-1.5 rounded-full bg-white/20 px-4 py-2 hover:bg-white/30 transition active:scale-95 whitespace-nowrap border border-white/40"
