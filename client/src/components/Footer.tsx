...
export function Footer() {
  ...
  return (
    <footer className="kna-footer bg-black text-white">
      <div className="kna-footer-inner max-w-7xl mx-auto px-4 sm:px-6 py-16">
        {/* 팔로우 - 상단 한 줄 */}
        <div className="flex items-center justify-center gap-6 mb-12">
          <span className="text-[20px] kna-footer-follow">팔로우</span>
        ...
        <div className="mt-8 pt-8 text-center">
          <p className="text-[10px] md:text-sm text-white/50 kna-footer-copyright">
