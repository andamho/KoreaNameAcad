...
export default function KnaPricingSection({ showHero = false }: KnaPricingSectionProps) {
  return (
    <>
      ...
      {showHero && (
        <section className="kna-pricing-hero relative overflow-hidden bg-gradient-to-br from-[#0f766e] to-[#4fd1c5] dark:from-[#0a5850] dark:to-[#3ba89e] pt-24 pb-16 md:pt-32 md:pb-24">
