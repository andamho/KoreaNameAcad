                ...
                >
                  ...
                  <div className="col-span-6 sm:col-span-4 text-right text-foreground">
                    <span className="sm:hidden font-semibold">
                      6만원
                      <br /><span className="text-[17px] font-normal whitespace-nowrap">[가족 4명 24만원]</span>
                    </span>
              ...
              return (
                ...
                >
                  <div className="col-span-6 sm:col-span-8 pr-2 text-muted-foreground leading-relaxed tracking-wide">
                    이름감명<br className="sm:hidden" /><span className="whitespace-nowrap">(다른 곳에서 지은 이름)</span>
                  </div>
