    ...
    <section className="relative overflow-hidden bg-white dark:bg-background text-gray-900 dark:text-foreground">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-16 sm:py-20 lg:px-8">
        <header className="mx-auto max-w-3xl text-center">
          <h2 className="mt-4 bg-gradient-to-r from-[#0f766e] to-[#4fd1c5] dark:from-[#58C4C4] dark:to-[#6DD4D4] bg-clip-text text-2xl font-extrabold leading-tight text-transparent sm:text-3xl md:text-4xl break-keep">
            열심히 노력하며 살아가지만
          </h2>
        ...
        <div className="mt-10 max-w-5xl mx-auto rounded-2xl border border-gray-200 dark:border-border bg-white/90 dark:bg-card/90 p-6 shadow-sm md:p-8">
          <div className="grid items-start gap-8 md:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-4 text-base md:text-lg text-gray-700 dark:text-muted-foreground">
...
function Testimonial({ quote }: { quote: string }) {
  return (
    <figure className="rounded-xl border border-gray-200 dark:border-border bg-white dark:bg-card p-4 shadow-sm">
      <blockquote className="text-base md:text-lg text-[#0f766e] dark:text-[#58C4C4]">"{quote}"</blockquote>
    </figure>
  );
}
