        ...
        <div className="mt-10 max-w-5xl mx-auto rounded-2xl border border-gray-200 dark:border-border bg-white/90 dark:bg-card/90 p-6 shadow-sm md:p-8">
          <div className="grid items-start gap-8 md:grid-cols-2">
            ...
            <div className="order-2">
              <div className="relative rounded-2xl border border-[#56D5DB]/30 dark:border-[#58C4C4]/30 bg-gradient-to-br from-[#56D5DB]/5 to-[#7fe1d3]/10 dark:from-[#58C4C4]/10 dark:to-[#45B8B8]/5 p-5 pt-10 pb-14">
                ...
                <svg 
                  className="absolute bottom-4 right-4 w-8 h-8 text-[#56D5DB] dark:text-[#58C4C4] opacity-80"
                  viewBox="0 0 24 24" 
                  fill="currentColor"
                  aria-hidden="true"
                >
