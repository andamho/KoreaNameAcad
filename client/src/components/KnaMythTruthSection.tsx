    ...
    <section className="kna-myth-truth-section relative overflow-hidden bg-white dark:bg-background">
      <div className="kna-myth-truth-inner relative max-w-6xl mx-auto px-6 lg:px-8 pt-24 pb-24 lg:pt-48 lg:pb-48">
        ...
        <div className="relative">
          {/* 배경 FAQ 텍스트 */}
          <span 
            className="absolute -top-[5%] right-0 translate-x-[15%] text-[300px] md:text-[450px] lg:text-[550px] font-black text-[#18a999]/8 dark:text-[#18a999]/5 select-none pointer-events-none tracking-tighter leading-none -rotate-[15deg] origin-top-right"
            aria-hidden="true"
          >
            FAQ
          </span>
