...
export default function KnaMythTruthSection() {
  const items = [
    ...
    },
    {
      ...
      a: (
        <>
          매년 약 <b>15만 명</b>이 개명합니다.<br />
          그래서 문의주신 분들 중에도 개명하신 분들이 많은데 상담해 드리면<br />
    ...
    <section className="kna-myth-truth-section relative overflow-hidden bg-white dark:bg-background">
      <div className="kna-myth-truth-inner relative max-w-6xl mx-auto px-6 lg:px-8 pt-24 pb-24 lg:pt-48 lg:pb-48">
        ...
        <div className="relative">
          {/* 배경 FAQ 텍스트 */}
          <span 
            className="absolute top-[5%] left-[15%] md:left-[35%] text-[50vw] md:text-[35vw] font-black text-gray-100/50 dark:text-gray-800/10 select-none pointer-events-none leading-none rotate-[-15deg]"
            aria-hidden="true"
          >
            FAQ
          </span>
          ...
          <div className="flex items-center gap-4 mt-10">
            <a href="https://blog.naver.com/whats_ur_name_777/221277653666" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center rounded-full bg-gray-900 dark:bg-white px-4 py-1.5 text-sm font-medium text-white dark:text-gray-900 transition hover:bg-gray-800 dark:hover:bg-gray-100">
              개명 안내 <span className="ml-1">›</span>
            </a>
          </div>
        </div>
      </div>
