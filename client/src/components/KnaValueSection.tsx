        ...
        <section className="mt-12 rounded-2xl border border-[#56D5DB] bg-[#56D5DB] p-6 shadow-lg shadow-[#56D5DB]/40">
          ...
          <ul className="mt-4 space-y-3">
            <li className="flex items-start gap-3">
              <span className="kna-value-badge inline-flex h-6 w-6 flex-none items-center justify-center rounded-full bg-transparent border-2 border-white text-sm font-bold text-white">1</span>
              <span className="text-lg text-white">상담·개명 후기 기반 1차 검증</span>
            </li>
            <li className="flex items-start gap-3">
              <span className="kna-value-badge inline-flex h-6 w-6 flex-none items-center justify-center rounded-full bg-transparent border-2 border-white text-sm font-bold text-white">2</span>
              <span className="text-lg text-white">이름만으로 운명상담 통해 2차 검증</span>
            </li>
          </ul>
        </section>
      </div>
