        ...
        <section className="mt-12 rounded-2xl border border-[#56D5DB] bg-[#56D5DB] p-6 shadow-lg shadow-[#56D5DB]/40">
          ...
          <ul className="mt-4 space-y-3">
            <li className="flex items-start gap-3">
              <span className="self-start mt-[0.2em] inline-flex h-6 w-6 flex-none items-center justify-center rounded-full bg-transparent border-2 border-white text-sm font-bold text-white">1</span>
              <span className="text-lg md:text-lg text-white leading-[1.4]">상담·개명 후기 기반 1차 검증</span>
            </li>
            <li className="flex items-start gap-3">
              <span className="self-start mt-[0.2em] inline-flex h-6 w-6 flex-none items-center justify-center rounded-full bg-transparent border-2 border-white text-sm font-bold text-white">2</span>
              <span className="text-lg md:text-lg text-white leading-[1.4]">이름만으로 운명상담 통해 2차 검증</span>
            </li>
          </ul>
        </section>
      </div>
