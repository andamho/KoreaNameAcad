...
export default function IdentityMap() {
  ...
  return (
    <div
      ref={containerRef}
      className="relative w-full aspect-[1/1.3] max-w-[500px] lg:max-w-none lg:aspect-auto lg:h-full lg:min-h-[400px] mx-auto rounded-3xl rounded-t-none lg:rounded-l-none lg:rounded-tr-3xl"
