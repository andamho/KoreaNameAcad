  ...
  return (
    ...
    >
      ...
      <div className="id-node absolute top-[8%] md:top-[15%] left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center z-20" id="n1" style={{ "--c": "#ff4757", animationDelay: "0s" } as React.CSSProperties}>
        ...
        <div className="anchor text-white font-black text-sm md:text-base px-2.5 py-1 rounded-xl whitespace-nowrap" style={{ background: "#ff3b4f", boxShadow: "0 0 25px rgba(255, 59, 79, 0.5)", border: "1.5px solid rgba(255,255,255,0.25)" }}>홍길동</div>
      </div>
      ...
      {/* n8: 사업자명 - 모바일에서 더 아래로 */}
      <div className="id-node absolute top-[55%] md:top-[55%] left-[88%] md:left-[72%] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center z-20" id="n8" style={{ "--c": "#7bed9f", animationDelay: "3.5s" } as React.CSSProperties}>
