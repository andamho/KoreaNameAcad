...
export default function IdentityMap() {
  ...
  return (
    ...
    >
      ...
      <div className="id-node absolute top-[48%] md:top-[56%] left-[12%] md:left-[10%] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center z-20" id="n2" style={{ "--c": "#ffa502", animationDelay: "0.5s" } as React.CSSProperties}>
