...
export function Navbar() {
  ...
  return (
    <>
      <nav className={`kna-navbar fixed top-0 left-0 right-0 z-50 transition-all duration-200 ${scrolled ? 'backdrop-blur shadow-sm' : ''}`} style={{ backgroundColor: scrolled ? 'rgba(250,250,250,0.95)' : '#fff8f2' }}>
