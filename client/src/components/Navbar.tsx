...
export function Navbar() {
  ...
  return (
    <>
      <nav className={`kna-navbar fixed top-0 left-0 right-0 z-50 transition-shadow duration-100 ${scrolled ? 'bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/80 shadow-sm' : ''}`} style={!scrolled ? { backgroundColor: '#fff8f2' } : {}}>
