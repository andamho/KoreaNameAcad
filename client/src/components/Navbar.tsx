          ...
          <div className="flex items-center justify-between h-20 md:h-[100px]">
            ...
            <div className="flex items-center gap-1 sm:gap-3 pr-0.5">
              ...
              <Button
                ...
                className="flex items-center gap-2 md:gap-2 scale-[1.9] md:scale-[1.5] pr-2 sm:pr-3"
              >
                {menuOpen ? (
                  <X className="h-5 w-5 md:h-6 md:w-6 md:[stroke-width:2.5]" />
                ) : (
                  <Menu className="h-5 w-5 md:h-6 md:w-6 md:[stroke-width:2.5]" />
                )}
