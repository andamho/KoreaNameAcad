        ...
        <div className="max-w-7xl mx-auto px-1 sm:px-6">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-2">
              ...
              >
                <img 
                  ...
                  alt="한국이름학교 로고" 
                  className="h-16 w-16 md:h-[58px] md:w-[58px] -mr-2"
                  loading="eager"
                  decoding="sync"
                  onLoad={() => {
                    // 큰 로고 미리 로드
            ...
            <div className="flex items-center gap-1 sm:gap-3">
              ...
              >
                {menuOpen ? (
                  <X className="h-5 w-5 md:h-6 md:w-6 md:scale-[1.26] text-[#58C4C4]" />
                ) : (
                  <Menu className="h-5 w-5 md:h-6 md:w-6 md:scale-[1.26] text-[#58C4C4]" />
                )}
