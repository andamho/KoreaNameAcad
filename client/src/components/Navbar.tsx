          ...
          <div className="flex items-center justify-between h-[68px]">
            <div className="flex items-center gap-2">
              ...
              >
                <img 
                  ...
                  alt="한국이름학교 로고" 
                  className="h-[68px] w-[68px] md:h-[61px] md:w-[61px] -ml-[12px] -mr-[11px]"
                  loading="eager"
                  decoding="sync"
                  onLoad={() => {
                    // 큰 로고 미리 로드
            ...
            <div className="flex items-center gap-1 sm:gap-3">
              <Button
                ...
                className="flex items-center gap-2 md:gap-2 md:scale-100 -mr-[10px] sm:mr-0 sm:pr-3"
              >
                {menuOpen ? (
                  <X className="!h-[37px] !w-[37px] md:!h-6 md:!w-6 md:scale-[1.26] text-[#58C4C4]" strokeWidth={2.3} />
                ) : (
                  <Menu className="!h-[37px] !w-[37px] md:!h-6 md:!w-6 md:scale-[1.26] text-[#58C4C4]" strokeWidth={2.3} />
                )}
