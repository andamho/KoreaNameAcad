...
//
// 또 하나 — 예약된 문자는 만들 때의 고객 전화번호를 그대로 복사해 둔다.
// 번호가 비어 있는 상태에서 시퀀스를 시작하면 '미입력' 같은 값이 박히고,
// 나중에 고객 번호를 채워도 이미 예약된 문자는 그대로다. Solapi 가
// "'to' 필드는 숫자만" 오류를 낸다. 2026-08-24 에 실제로 그랬다.
