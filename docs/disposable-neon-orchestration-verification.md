...
## 4. 검증 capability (39종, `CAPABILITY_CHECKS`)
...
- **Privilege**: PUBLIC table/sequence/function-EXECUTE 0 · reader SELECT-only · writer 허용 INSERT · writer UPDATE/DELETE/TRUNCATE 거부 · writer business-table 접근 거부 · app simulation write 거부 · trigger function 직접 호출 거부 · default privileges.
